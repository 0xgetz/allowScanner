...
from allowscanner.core.exceptions import AllowScannerError, NetworkError
...
class TestHttpClientCreation:
    ...
    def test_client_created_with_config(self, config: ScanConfig) -> None:
        """Test that HttpClient is created with config."""
        client = HttpClient(config)
        assert client.config == config
        assert client._session is None

    def test_client_default_user_agent(self, config: ScanConfig) -> None:
...
class TestHttpClientStart:
    ...
    @pytest.mark.asyncio
    async def test_start_creates_session(self, client: HttpClient) -> None:
    ...
    @pytest.mark.asyncio
    async def test_start_creates_ssl_context(self, client: HttpClient) -> None:
    ...
    @pytest.mark.asyncio
    async def test_start_sets_timeout(self, client: HttpClient) -> None:
...
class TestHttpGet:
    ...
    @pytest.mark.asyncio
    async def test_get_returns_response_and_content(self, client: HttpClient) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_with_headers(self, client: HttpClient) -> None:
        ...
        # get() now routes through session.request("GET", ...)
        assert len(mock_session.request.call_args_list) > 0
        call_args, call_kwargs = mock_session.request.call_args_list[0]
        assert call_args[0] == "GET"
        assert call_args[1] == "https://example.com"
        assert call_kwargs["headers"] == headers

    @pytest.mark.asyncio
    async def test_get_raises_network_error_on_exception(self, client: HttpClient) -> None:
...
class TestHttpRequest:
    ...
    @pytest.mark.asyncio
    async def test_request_post_returns_response(self, client: HttpClient) -> None:
    ...
    @pytest.mark.asyncio
    async def test_request_passes_method_correctly(self, client: HttpClient) -> None:
        ...
        # request() now routes through session.request(method, ...)
        assert len(mock_session.request.call_args_list) > 0
        call_args, _ = mock_session.request.call_args_list[0]
        assert call_args[0] == "DELETE"
        assert call_args[1] == "https://example.com/resource"

    @pytest.mark.asyncio
    async def test_request_raises_network_error_on_exception(self, client: HttpClient) -> None:
...
class TestHttpClientClose:
    ...
    @pytest.mark.asyncio
    async def test_close_closes_session(self, client: HttpClient) -> None:
    ...
    @pytest.mark.asyncio
    async def test_close_handles_none_session(self, client: HttpClient) -> None:
...
class TestSessionProperty:
    ...
    def test_session_property_returns_session(self, client: HttpClient) -> None:
    ...
    def test_session_property_raises_when_not_started(self, client: HttpClient) -> None:
...
class TestSSLVerification:
    ...
    @pytest.mark.asyncio
    async def test_ssl_verification_enabled_by_default(self, client: HttpClient) -> None:
...
class TestConcurrencyLimit:
    ...
    @pytest.mark.asyncio
    async def test_connector_respects_concurrency_limit(self, client: HttpClient) -> None:
...
class TestUserAgent:
    ...
    @pytest.mark.asyncio
    async def test_custom_user_agent(self, client: HttpClient) -> None:
